...
function wp_bootstrap_custom_admin_footer() {
	echo '<span id="footer-thankyou">Theme developed by <a href="http://mintcanary.com/" target="_blank">Mint Canary</a>. Built using <a href="http://320press.com" target="_blank">WP-Bootstrap</a></span>.';
}
...
function baw_hack_wp_title_for_home( $title )
{
  if( empty( $title ) && ( is_home() || is_front_page() ) ) {
    return __( get_bloginfo( 'name' ), 'wpbsone' ) . ' - ' . get_bloginfo( 'description' );
  }
  return $title;
}

// logo
function wpbsone_theme_customizer( $wp_customize ) {
    $wp_customize->add_section( 'wpbsone_logo_section' , array(
				'title'       => __( 'Logo', 'wpbsone' ),
				'priority'    => 30,
				'description' => 'Upload a logo to replace the default site name and description in the header',
		) );
		$wp_customize->add_setting( 'wpbsone_logo' );
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'wpbsone_logo', array(
    'label'    => __( 'Logo', 'wpbsone' ),
    'section'  => 'wpbsone_logo_section',
    'settings' => 'wpbsone_logo',
) ) );
}
